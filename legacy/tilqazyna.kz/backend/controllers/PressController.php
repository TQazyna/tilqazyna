    ...
    public function actions()
    {
        return [
            'image-upload' => [
                ...
                'path' => '@frontend/web/press/' // Or absolute path to directory where files are stored.
            ],
        ];
    }
    public function actionIndex()
    {
       /* $user = User::findOne(9);
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => Press::find()->orderBy("id desc"),
        ]);
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($file && $file->tempName) {
                ...
                if ($model->validate(['file'])) {
                    ...
                    $dir = Yii::getAlias('@frontend/web/press/');
                    $dir2 = Yii::getAlias('press/');
