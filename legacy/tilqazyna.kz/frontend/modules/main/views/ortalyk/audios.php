    ...
    <div class="main-page__in floated">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar__sections">
                ...
                <a href="/adis" class="sidebar__section <?php if(empty($cat)){echo 'sidebar__section--active';} ?>">Барлығы</a>
                <a href="/adis/kenes" class="sidebar__section <?php if($cat == 'kenes'){echo 'sidebar__section--active';} ?>">Ғалымнан кеңес</a>
                <a href="/adis/komek" class="sidebar__section <?php if($cat == 'komek'){echo 'sidebar__section--active';} ?>">Әдіскерге көмек</a>
                <a href="/adis/videos" class="sidebar__section <?php if($cat == 'videos'){echo 'sidebar__section--active';} ?>">Видео</a>
                <a href="/adis/audios" class="sidebar__section <?php if($cat == 'audios'){echo 'sidebar__section--active';} ?>">Аудио</a>
            </div>
