    ...
    <div class="main-page__in floated">
        <div class="main-page__left">
			<div class="breadcrumb-b">
				<span class="breadcrumb">Тұғыр   /   Орта   /   <?php echo $title?></span>
			</div>
            <div class="main-page__title-b" style="height: auto;">
                <h3 class="news__title"><?php echo $title?></h3>
				<div class="main-page__item__title__tags" style="margin-right: 10px;">
					<?php foreach ($cats as $k=>$c_title) {?>
						<a href="/neworta/<?php echo $cat;?>/<?php echo $k?>" <?php if ($k==$selected):?>class="active"<?php endif?>><span class="main-page__item__title__tag"><?php echo $c_title?></span></a>
					<?php } ?>
                    ...
                    <?if(false && $i == 1){?>
                        <div class="main-page__news-main">
                            ...
                            <div class="main-page__news-main__text-b">
                                ...
                                <div class="main-page__news-main__title"><?php echo $article['title']?></div>
                            </div>
                    ...
                    <?php }else{?>
                        <div class="main-page__news">
                            ...
                            <div class="main-page__news__body">
                                <h2 class="main-page__news__section"><?php echo \common\components\MyLib\MyLib::getCatName($article['cat_id']) ?></h2>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar__sections">
                ...
                <a href="/neworta" class="sidebar__section <?php if(empty($cat)){echo 'sidebar__section--active';} ?>">Барлығы</a>
				<?php foreach($categories as $c) : ?>
                <a href="/neworta/<?php echo $c->alias;?>" class="sidebar__section <?php if($cat == $c->alias){echo 'sidebar__section--active';} ?>"><?php echo $c->title;?></a>
				<?php endforeach; ?>
            </div>
