    ...
    <div class="news-page__in floated">
        <div class="main-page__left">
            <div class="breadcrumb-b">
                <span class="breadcrumb">Тұғыр   /   Үздік сабақ<?// if($art['cat_id']==11 and !empty($art['cat'])){echo $art['cat'];}else{ echo \common\components\MyLib\MyLib::getCatName($art['cat_id']);} ?></span>
            </div>
            <div class="news-item">
                ...
                <div class="news-item__body">
                    ...
                    <div class="floated">
                        <div class="news-item__title-img-b">
                            <? if($art['cat_id']==15){ ?>
                                <img src="<? echo \common\components\MyLib\MyLib::getImg($art['id']) ?>" class="news-item__title-img" alt=""/>
                            ...
                            <?}else{?>
                            <img src="<?=$art['img']?>" class="news-item__title-img" alt=""/>
                            <?}?>
                            <div class="news-item__title-social-b floated">
                                <div class="news-item__social-b">
                                    <script src="//yastatic.net/es5-shims/0.0.2/es5-shims.min.js"></script>
<script src="//yastatic.net/share2/share.js"></script>
<div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,moimir,gplus,twitter" data-image='http://tilalemi.kz<?=$art['img']?>' ></div>
                                </div>
                            </div>
                        </div>
                        <?if($art['cat_id']!=18){?>
                        <div class="news-item__title-text"><?=$art['prev']?></div>
                        <?}?>
                    </div>

                    <div class="news-item__text">
						<? if (strlen($art['audio']) > 0) : ?>
                            <audio controls>
                    ...
                    <div class="review-b">
						...
						<div class="fb-comments" data-href="<?=yii\helpers\Url::canonical()//(Yii::$app->request->url, true);?>" data-width="auto" data-numposts="5"></div>
						<!-- /facebook comments plugin -->
                    </div>
                </div>
            ...
            <div class="main-page__news-b floated">
                <?php
                $i = 1;
                foreach ($mores as $art) {?>
                <div class="main-page__news <?php if($i !== 1){ echo "main-page__news--desktop";} ?>">
