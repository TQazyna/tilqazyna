                ...
                <div class="swiper-slide">
                    <div class="swiper-container main-swiper-container swiper-initialized swiper-horizontal swiper-pointer-events">
                        <div class="slider__item">
                            <a href="/register"><img src="/img/til-jane-qogam2024qabildau.jpg" alt="Тіл және қоғам журналы"
                                    class="slider__image-src"></a>
                        </div>
                        <div class="slider__item">
                            <a href="/register"><img src="/img/til-jane-qogam2024qabildau.jpg" alt="Тіл және қоғам журналы"
                                    class="slider__image-src"></a>
...
<section class="container news-section">
    <div class="content">
        <div class="col-md-12 bgwhite" style="margin-top: 30px">
            <!-- col-md-19  -->
            <div>
                <div id="news" class="news">
                    ...
                    <div class="card-deck news-box evgd-news-main">
                        <?php foreach ($news as $row) { ?>
                            <div class="card evgd-news-card">
                                <a href="/article/<?php echo $row['id'] ?>" class="card-link">
                                    <img src="/<?php print_r($row['img']) ?>" alt="<?php echo $row['title'] ?>" class="card-img-top">
                                </a>
                                <div class="card-body">
                                    <a href="/article/<?php echo $row['id'] ?>" class="card-link">
                                ...
                                <div class="card-footer bg-transparent">
                                    <a href="/article/<?php echo $row['id'] ?>" class="card-link">Толығырақ
                    ...
                    <a href="/news" class="all-news"><img src="/padnote.png" alt="...">Барлық
                        жаңалықтар</a>
                </div>
            </div>
        </div>
...
<section class="project-container paddingtop20">
    <div class="container" style="min-height: 500px;width: 1289px;">
...
<section class="Youtube-container">
    <div class="container" style="min-height: 300px; width:1291px;min-height:333px;">
        ...
        <div class="swiper swiper-carousel-video">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><iframe width="370" height="215"
                        src="https://www.youtube.com/embed/2GULoyhaPtE" title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe></div>
                <div class="swiper-slide"><iframe width="370" height="215"
                        src="https://www.youtube.com/embed/17dEoUBq3KA" title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe></div>
                <div class="swiper-slide"><iframe width="370" height="215"
                        src="https://www.youtube.com/embed/Vb5XphdK8Gc" title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe></div>
            </div>
...
<section class="carousel-container">
    <div class="container" style="width:1291px;min-height: 300px;">
        ...
        <div class="swiper swiper-carousel">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="/img/carousel/Adm.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/img/carousel/GJBM.png" alt=""></div>
                <div class="swiper-slide"><img src="/img/carousel/MSM.jpg" alt=""></div>
                <div class="swiper-slide"><img src="/img/carousel/TIL.png" alt=""></div>
                <div class="swiper-slide"><img src="/img/carousel/Tbi.png" alt=""></div>
