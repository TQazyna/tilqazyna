<?php
$this->title = 'Тіл Әлемі - Басты бет';
...
<div class="main-page">
    <div class="main-page__in floated">
        ...
        <div class="main-page__left">
                ...
                <div style="display:inline-block; width:98%;"  class="">
                            <video autoplay loop controls  width="100%">
                            <source src = "//tilalemi.kz/file/12.mp4" type = 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
            ...
            <!--<video width="96%" height="95%" autoplay loop muted playsinline style="margin-right: auto; display: block">
                <source src="forum2019.mp4" type="video/mp4" />
            </video>-->
            <br>
            <div class="main-page__title-b">
                <h3 class="news__title">Тұғыр</h3>
            </div>
            <div class="main-page__news-b floated">
                ...
                <div class="main-page__news-main">
                    <img src="<?php echo $article['img']?>" class="main-page__news-main__img"/>
                    ...
                    <div class="main-page__news-main__text-b">
                        <div style="margin-left:20px;" class="main-page__news-main__section"><?php if($article['cat_id']==11 and !empty($article['cat'])){echo $article['cat'];}else{ echo \common\components\MyLib\MyLib::getCatName($article['cat_id']);} ?></div>
                        <a   href="/article/<?php echo $article['id']?>"><div style="margin-left:20px;" class="main-page__news-main__title"><?php echo $article['title']?></div></a>
                    </div>
                    <a href="/article/<?php echo $article['id']?>" class="main-page__news-main__link js-views-link"></a>
                </div>
                <?php }else{?>
                <div class="main-page__news">
                    <div class="main-page__news__img-b">
                        <img src="<?php echo $article['img']?>" class="main-page__news__img"/>
                        <div class="main-page__views-b js-views-b">
                                    <span class="main-page__views">
                                         <svg version="1.1" class="main-page__views-icon" viewBox="0 0 21 12" enable-background="new 0 0 21 12">
                                             <path fill="#FFF" d="M11.028,2.346c-1-0.138-1.994,0.112-2.8,0.705C6.565,4.274,6.23,6.591,7.48,8.217c0.606,0.789,1.492,1.3,2.492,1.438c0.178,0.024,0.358,0.037,0.536,0.037c0.814,0,1.602-0.256,2.263-0.743c1.662-1.222,1.998-3.539,0.748-5.166C12.913,2.994,12.028,2.483,11.028,2.346z M11.946,7.885c-0.514,0.378-1.147,0.537-1.782,0.449C9.528,8.246,8.963,7.921,8.577,7.418c-0.799-1.04-0.586-2.521,0.477-3.303c0.514-0.378,1.146-0.537,1.783-0.449c0.637,0.088,1.201,0.413,1.586,0.915C13.223,5.622,13.008,7.104,11.946,7.885zM11.212,4.418c-0.243,0-0.477,0.093-0.646,0.26c-0.171,0.164-0.267,0.394-0.267,0.629c0,0.233,0.096,0.462,0.267,0.629c0.169,0.164,0.403,0.26,0.646,0.26c0.24,0,0.476-0.096,0.645-0.26c0.172-0.167,0.268-0.396,0.268-0.629c0-0.235-0.096-0.465-0.268-0.629C11.688,4.511,11.452,4.418,11.212,4.418z M20.846,5.505C20.691,5.28,16.98,0,10.5,0C4.02,0,0.309,5.28,0.154,5.505c-0.206,0.3-0.206,0.69,0,0.99C0.309,6.72,4.02,12,10.5,12c6.481,0,10.192-5.28,10.346-5.505C21.052,6.195,21.052,5.805,20.846,5.505z M10.5,10.223c-4.409,0-7.41-3.014-8.438-4.225c1.023-1.212,4.009-4.22,8.438-4.22c4.409,0,7.41,3.011,8.437,4.222C17.907,7.212,14.906,10.223,10.5,10.223z"/>
                        ...
                        <a href="/article/<?php echo $article['id']?>" class="main-page__news__link js-views-link"></a>
                    </div>
                    <div class="main-page__news__body">
                        <h2 class="main-page__news__section"><?php if($article['cat_id']==11 and !empty($article['cat'])){echo $article['cat'];}else{ echo \common\components\MyLib\MyLib::getCatName($article['cat_id']);} ?></h2>
                        <a href="/article/<?php echo $article['id']?>"><h3 class="main-page__news__title"><?php echo $article['title']?></h3></a>
						<p style="text-align:right;margin-bottom:5px;"><?php echo date('d.m.Y', $article['orders'])?></p>
        ...
        <div class="sidebar">
            ...
            <?php // echo \frontend\widgets\More::widget();?> <!-- КӨП ОҚЫЛҒАНДАР -->
        </div>
    </div>

    <div class="main-page__tolganys-b">
        <div class="main-page__tolganys__title-b">
            <a href="/tolganys"><h2 class="main-page__tolganys__title">Толғаныс</h2></a>
            <div class="main-page__tolganys__sections"></div>
            <a href="/profile/create" class="main-page__tolganys__all-link">
                Блог ашу
                <svg class="main-page__news__all-link__icon" version="1.1" viewBox="0 0 15 12" enable-background="new 0 0 15 12" xml:space="preserve">
        ...
        <div class="main-page__tolganys__items floated">
            ...
            foreach ($blogs as $blog) {?>
                <div class="main-page__tolganys__item <?php if($i == 2 or $i == 3){echo ' main-page__tolganys__item--mobile';}elseif($i==4){echo 'main-page__tolganys__item--last';} ?>">
                    <div class="main-page__tolganys__img-b">
                        <img src="<?php echo $blog['img']?>" class="main-page__tolganys__img">
                    </div>
                    <div class="main-page__tolganys__item__body">
                        <a href="/article/<?php echo $blog['id']?>"><h3 class="main-page__tolganys__item__title"><?php echo $blog['title']?></h3></a>
                        <div class="main-page__tolganys__item__views-b">
                                    <span class="main-page__tolganys__item__views">
                                         ...
                                         <?php //=$blog['date']?><?php echo date('d.m.Y', $blog['orders'])?>
                                    </span>
                                    <span class="main-page__tolganys__item__views">
                                        <svg version="1.1" class="main-page__views-icon" viewBox="0 0 21 12" enable-background="new 0 0 21 12">
                        ...
                        <div class="main-page__tolganys__item__author-b floated">
                            ...
                            ?>
                            <img src="<?php if(!empty($user['avatar'])){echo $user['avatar'];}else{echo "/img/user.png";} ?>" class="main-page__tolganys__item__author-img"/>
                            <a href="/users/<?php echo $user['id']?>" class="main-page__tolganys__item__author-link">
                                <?php echo $user['username']?><br><?php echo $user['lastname']?>
                            </a>
                        </div>
                        <div class="main-page__tolganys__item__status-b">
                            <span class="main-page__rating__status">статус:</span><span class="main-page__rating__status-text"><?php echo \common\components\MyLib\MyLib::getRole($user['link_role']);?></span>
                        </div>
                    </div>
                </div>
            <?php
    ...
    <div class="main-page__tartu-b">
        <div class="main-page__item__title-b floated">
            <a href="/tartu"><h3 class="main-page__item__title">ТАРТУ</h3></a>
        ...
        <div class="main-page__tartu__items floated">
            ...
            foreach ($books as $book) {?>
                <div class="main-page__tartu <?php if($i == 3 or $i == 4){echo ' main-page__tartu--mobile';}elseif($i==5){echo 'main-page__tartu--last';} ?> ">
                    <div class="main-page__tartu__img-b">
                        <img src="<?php echo $book['img']?>" class="main-page__tartu__img"/>
                        <div class="main-page__tartu__link-b js-tartu-link">
                            <a href="/tartu/one/<?php echo $book['id']?>" class="main-page__tartu__link js-tartu-b">Оқу</a>
                        </div>
                    </div>
                    <a href="" class="main-page__tartu__section"><?php echo $book['title']?></a>
                    <div class="main-page__tartu__author"><?php echo $book['author']?></div>
                </div>
            <?php $i++;    }
            ?>
        </div>
    ...
    <div class="main-page__media-b">
        <div class="main-page__item__title-b floated">
            <a href="/adis/videos"><h3 class="main-page__item__title">МУЛЬТИМЕДИА</h3></a>
            <div class="main-page__item__title__tags">
                <span class="main-page__item__title__tag">Видео</span>
				<span class="main-page__item__title__tag">Аудио</span>
            </div>
        </div>

        <div class="main-page__media__items floated profile__tab profile__tab--active">
		...
		<div class="main-page__media__items floated profile__tab">
            <?php
                    $i = 1;
                    foreach ($audios as $audio) {
                        if($i == 1){?>
                            <div style="height:429px;" class="main-page__media main-page__media--audio main-page__media--main">
                                <div class="main-page__media__text-b">
                                    <?php echo $audio['title']?>
                                </div>
                                <a href="/article/<?php echo $audio['id']?>" class="block-link"></a>
                            </div>
                        <?php }else{?>
    ...
    <div class="main-page__partner-b">
        <div id="owl-demo" class="owl-carousel">
            <a href="http://www.pm.kz" target="_blank">
                <div class="item"><img src="/img/partners/004.png" alt="Owl Image"></div>
            </a>
            <a href="http://mks.gov.kz/kaz/" target="_blank">
                <div class="item"><img  src="/img/partners/008.png" alt="Owl Image"></div>
            </a>
            <a href="https://strategy2050.kz/" target="_blank">
            <div class="item"><img  src="/img/partners/logopartner-007.png" alt="Owl Image"></div>
            </a>
            <a href="">
            <div class="item"><img src="/img/partners/002.png" alt="Owl Image"></div>
            </a>
			<a href="http://www.adebiportal.kz/" target="_blank">

            <div class="item"><img src="/img/partners/005.png" alt="Owl Image"></div>
            </a>
            <a href="http://www.baq.kz" target="_blank">
            <div class="item"><img  src="/img/partners/003.png" alt="Owl Image"></div>
            </a>
            ...
            <div class="item"><img  src="/img/partners/010.png" alt="Owl Image"></div>
            </a>
            <a href="http://kaztv.kaztrk.kz/kz/" target="_blank">

            <div class="item"><img src="/img/partners/001.png" alt="Owl Image"></div>
            </a>
			<a href="http://kazakhtest.kz/" target="_blank">

            <div class="item"><img src="/img/partners/006.png" alt="Owl Image"></div>
            </a>
			<a href="http://anatili.kazgazeta.kz/" target="_blank">

            <div class="item"><img src="/img/partners/007.png" alt="Owl Image"></div>
            </a>
			<a href="http://tbi.kz/" target="_blank">

            <div class="item"><img  src="/img/partners/009.png" alt="Owl Image"></div>
            </a>
			<a href="https://yenshi.kz/" target="_blank">

            <div class="item"><img  src="/img/partners/013.png" alt="Owl Image"></div>
            </a>
			<a href="https://www.facebook.com/qazlatyn.kz.1" target="_blank">

            <div class="item"><img  src="/img/partners/014.png" alt="Owl Image"></div>
            </a>
		</div>
    </div>
</div>
