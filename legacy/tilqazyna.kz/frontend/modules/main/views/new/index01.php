...
<div class="main-page">
    <div class="main-page__in floated">
        ...
        <div class="main-page__blog-b main-page__blog-b--mobile floated">
            <a href="/authors" class="main-page__blog main-page__blog--galym floated">
            ...
            <a href="/authors" class="main-page__blog main-page__blog--adisker floated">
                                    <span class="main-page__blog__text">
                                        Әдіскер
                                        <svg version="1.1" class="main-page__blog__arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"viewBox="0 0 10 16" enable-background="new 0 0 10 16" xml:space="preserve">
                                            <path fill="#FFFFFF" d="M9.631,7.205L1.984,0.309C1.516-0.115,0.771-0.1,0.321,0.339c-0.45,0.439-0.436,1.138,0.033,1.56L7.118,8l-6.765,6.102c-0.468,0.423-0.483,1.121-0.033,1.56C0.552,15.887,0.86,16,1.169,16c0.293,0,0.587-0.103,0.815-0.308l7.646-6.897C9.862,8.587,9.992,8.3,9.992,8S9.862,7.413,9.631,7.205z"/>
            ...
            <a href="/authors" class="main-page__blog main-page__blog--author floated">
                                    <span class="main-page__blog__text">
                                        Автор
                                        <svg version="1.1" class="main-page__blog__arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"viewBox="0 0 10 16" enable-background="new 0 0 10 16" xml:space="preserve">
                                            <path fill="#FFFFFF" d="M9.631,7.205L1.984,0.309C1.516-0.115,0.771-0.1,0.321,0.339c-0.45,0.439-0.436,1.138,0.033,1.56L7.118,8l-6.765,6.102c-0.468,0.423-0.483,1.121-0.033,1.56C0.552,15.887,0.86,16,1.169,16c0.293,0,0.587-0.103,0.815-0.308l7.646-6.897C9.862,8.587,9.992,8.3,9.992,8S9.862,7.413,9.631,7.205z"/>
        ...
        <div class="main-page__left">
            <div style="width: 96.96969697%;" class="main-page__hover-b">
                <?
                $i = 1;
                foreach ($sliders as $slider) {?>
                    <div style="height: 270px;" class="main-page__hover">
                        <img src="<?=$slider['img_slider']?>" style="width: 100%;" class="hover-img"/>
                        <div class="main-page__hover__in">
                            <div class="main-page__hover__body" style="line-height: 1.5;">
                                <b><?=$slider['title']?></b>
                                <p><?php echo \common\models\Articles::preview($slider['text']);?>...</p>
                                <a href="<? if($i == 1){echo "https://termincom.kz/";}elseif($i == 2){echo "http://atau.kz/";}else{echo "http://emle.kz/";} ?>" target="_blank" class="block-link"></a>
                            </div>
                            <div class="main-page__hover__bottom">
            ...
            <div class="main-page__blog-b main-page__blog-b--desktop floated">
                <a href="/authors" class="main-page__blog main-page__blog--galym floated">
                                    <span class="main-page__blog__text">
                                        Ғалым
                                        <svg version="1.1" class="main-page__blog__arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"viewBox="0 0 10 16" enable-background="new 0 0 10 16" xml:space="preserve">
            ...
            <div class="main-page__news-b floated">
                ...
                <div class="main-page__news-main">
                    ...
                    <div class="main-page__news-main__text-b">
                        <div style="margin-left:20px;" class="main-page__news-main__section"><? if($article['cat_id']==11 and !empty($article['cat'])){echo $article['cat'];}else{ echo \common\components\MyLib\MyLib::getCatName($article['cat_id']);} ?></div>
                        <a   href="/article/<?=$article['id']?>"><div style="margin-left:20px;" class="main-page__news-main__title"><?=$article['title']?></div></a>
                    </div>
                ...
                <div class="main-page__news">
                    ...
                    <div class="main-page__news__body">
                        <h2 class="main-page__news__section"><? if($article['cat_id']==11 and !empty($article['cat'])){echo $article['cat'];}else{ echo \common\components\MyLib\MyLib::getCatName($article['cat_id']);} ?></h2>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar__news-b" style="border: none;padding: 0;">
                    <div class="sidebar__news">
                        <a href="/article/239"><img src="/img/toraga.jpg" style="padding-bottom:10px;"></a>
                        <a href="" class="sidebar__news__link">Қуаныш  Асылов</a>
            ...
            <div class="sidebar__news-b" style="border: none;padding: 0;">
                    <div class="sidebar__news">
                        <a href="/memtil"><img width="100%" src="/img/ban2.png" style="padding-bottom:10px;"></a>
                    </div>
            </div>
    ...
    <div class="main-page__tolganys-b">
        ...
        <div class="main-page__tolganys__items floated">
            ...
            foreach ($blogs as $blog) {?>
                <div class="main-page__tolganys__item <? if($i == 2 or $i == 3){echo ' main-page__tolganys__item--mobile';}elseif($i==4){echo 'main-page__tolganys__item--last';} ?>">
        ...
        <?php $i = 1; foreach ($users as $user) {?>
            <div class="main-page__rating">
                <div class="main-page__rating__img-b">
                    <img src="<? if(!empty($user['avatar'])){echo $user['avatar'];}else{echo "/img/user.png";} ?>" class="main-page__rating__img"/>
                    <div class="main-page__rating__position"><?=$i?></div>
                </div>
                <a href="/users/<?=$user['id']?>"><h3 class="main-page__rating__name"><?=$user['username']?> <?=$user['lastname']?></h3></a>
                <div> <span class="main-page__rating__status">статус:</span><span class="main-page__rating__status-text"><? echo \common\components\MyLib\MyLib::getRole($user['link_role']);?></span></div>
            </div>
        <?
        $i++;
        }?>
    ...
    <div class="main-page__tartu-b">
        ...
        <div class="main-page__tartu__items floated">
            ...
            foreach ($books as $book) {?>
                <div class="main-page__tartu <? if($i == 3 or $i == 4){echo ' main-page__tartu--mobile';}elseif($i==5){echo 'main-page__tartu--last';} ?> ">
