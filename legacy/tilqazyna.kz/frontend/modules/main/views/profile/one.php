<?php
$this->title = "Тіл Әлемі - Айгул Сағымбайқызы";
    ...
    <div class="profile-page__in floated">
        <div class="main-page__left">
            <div class="breadcrumb-b">
                <span class="breadcrumb">Тұғыр   /   Профиль   / Айгул Сағымбайқызы</span>
            </div>
            <div class="profile-b">
                <div class="profile__img-b">
                    <img src="/img/profile.jpg" class="profile__img" />
                    <div class="profile__name-b floated">
                        <div class="profile__name__img-b">
                            <img src="/img/avatar.jpg" class="profile__name__img"/>
                        </div>
                        <div class="profile__name">
                            Айгул<br>Сағымбайқызы
                        </div>
                    </div>
                </div>
                <div class="profile__status-b floated">
                    <div class="profile__status">
                        <span class="main-page__rating__status">статус:</span><span class="main-page__rating__status-text">ғалым</span>
                    </div>
                    <a href="" class="profile__status__link">Жазылу</a>
                </div>
                <div class="profile__menu-b floated">
                    <span class="profile__menu__item  profile__menu__item--active">Өзі туралы</span>
                    <span class="profile__menu__item">Ғылымнан кеңес</span>
                    <span class="profile__menu__item">Әдіскерге көмек</span>
                    <span class="profile__menu__item">Бейне сабақтар</span>
                ...
                <div class="profile__tabs">
                    <div class="profile__tab  profile__tab--active">
                        <p>Туған күні: <b>20 ақпан 1985</b></p><br>
                        <p>Жынысы: <b>Әйел</b></p><br>
                        <p>Тұрмыстық жағдайы: <b>Досым бар</b></p><br>
                        <p>Ел: <b>Қазақстан</b></p><br>
                        <p>Қала: <b>Алматы</b></p><br>
                        <p>Ұялы телефон: <b>+77021993794</b></p><br>
                        <p>Веб-сайт: <b>https://vk.com/gmoldazhanova</b></p>
                    </div>
                            ...
                            <?php foreach ($arts as $art) {?>
                                <div class="main-page__news">
                                    <div class="main-page__news__img-b">
                                        <img width="300" height="200" src="<?php echo $art['img']?>" class="main-page__news__img"/>
                                    ...
                                    <div class="main-page__news__body">
                                        ...
                                        <a href="/article/<?php echo $art['id']."-".$art['preview'].".html";?>"><h3 class="main-page__news__title"><?php echo $art['title']?></h3></a>
                    ...
                    <div class="profile__tab">
                        <div class="main-page__media-b">
                            <div class="main-page__media__items floated">
                                <?php foreach ($arts4 as $art) {?>
                                    <div class="main-page__news" style="height:300px;">
                                        <div class="main-page__news__img-b">
                                            <img width="300" height="200" src="<?php echo $art['img']?>" class="main-page__news__img"/>
                                            <div class="main-page__views-b js-views-b">
                                                        <span class="main-page__views">
                            ...
                            <div class="main-page__tartu__items floated">
                                <div class="main-page__tartu">
                                    <div class="main-page__tartu__img-b">
                                        ...
                                        <div class="main-page__tartu__link-b js-tartu-link">
                                            <a href="/tartu/read" class="main-page__tartu__link js-tartu-b">Оку</a>
                                        </div>
                                    </div>
                                    <a href="/tartu/read" class="main-page__tartu__section">Абайдың<br> қара сөздері</a>
                                ...
                                <div class="main-page__tartu">
                                    <div class="main-page__tartu__img-b">
                                        ...
                                        <div class="main-page__tartu__link-b js-tartu-link">
                                            <a href="" class="main-page__tartu__link js-tartu-b">Оку</a>
                                        </div>
                                    </div>
                            ...
                            foreach ($blogs as $blog) {
                                ...
                                <div class="main-page__tolganys__item">
                                    <div class="main-page__tolganys__img-b">
                                        <img width="300" height="155" src="<?php echo $blog['img']?>" class="main-page__tolganys__img">
                                    </div>
                                    <div class="main-page__tolganys__item__body">
                                        <a href="/article/<?php echo $blog['id']."-".$blog['preview'].".html";?>"><h3 class="main-page__tolganys__item__title"><?php echo $blog['title']?></h3></a>
                                    ...
                                    <span class="main-page__tolganys__item__views">
                                        ...
                                        <div class="main-page__tolganys__item__author-b floated">
                                            <img width="42" height="42" src="/img/ava<?php echo $i?>.png" class="main-page__tolganys__item__author-img"/>
