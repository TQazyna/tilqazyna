...
<div class="main-page">
    <div class="main-page__in floated">
        <div class="main-page__left">
                    ...
                    <?php if(false && $i == 1){?>
                        <div class="main-page__news-main">
                            ...
                            <div class="main-page__news-main__text-b">
                                <div class="main-page__news-main__section"><?php echo \common\components\MyLib\MyLib::getCatName($article['cat_id']) ?></div>
                    ...
                    <?php }else{?>
                        <div class="main-page__news">
                            ...
                            <div class="main-page__news__body">
                                ...
                                <a href="/article/<?php echo $article['id']?>"><h3 class="main-page__news__title"><?=$article['title']?></h3></a>
            ...
            <div class="main-page__title-b">
                <h3 class="news__title"><a href="/neworta/ortalyk">ortalyk</a></h3>
            </div>
            <div class="main-page__news-b floated">
                <?php
                $i = 1;
                foreach ($ortalyk as $article) {?>
                    <?php if(false && $i == 1){?>
                        <div class="main-page__news-main">
                            <img src="<?php echo $article['img']?>" class="main-page__news-main__img"/>
                            <div class="main-page__views-b js-views-b">
