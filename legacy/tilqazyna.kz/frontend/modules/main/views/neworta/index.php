    ...
    <div class="main-page__in floated">
        <div class="main-page__left">
			<div class="breadcrumb-b">
				<span class="breadcrumb">Тұғыр   /   Орта</span>
			</div>
            <div class="main-page__title-b">
                <h3 class="news__title"><a href="/neworta/baykau">Байқау</a></h3>
            </div>
            <div class="main-page__news-b floated">
                <?php
                $i = 1;
                foreach ($baykau as $article) {?>
                    <?if(false && $i == 1){?>
            ...
            <div class="main-page__title-b">
                <h3 class="news__title"><a href="/neworta/is-shara">Іс-шара</a></h3>
            </div>
            <div class="main-page__news-b floated">
                <?php
                $i = 1;
                foreach ($is_shara as $article) {?>
                    <?if(false && $i == 1){?>
                        <div class="main-page__news-main">
                            <img src="<?=$article['img']?>" class="main-page__news-main__img"/>
                            <div class="main-page__views-b js-views-b">
            ...
            <div class="main-page__title-b">
                <h3 class="news__title"><a href="/neworta/seminar">Семинар</a></h3>
            </div>
            <div class="main-page__news-b floated">
                <?php
                $i = 1;
                foreach ($seminar as $article) {?>
                    <?if(false && $i == 1){?>
                        <div class="main-page__news-main">
                            <img src="<?=$article['img']?>" class="main-page__news-main__img"/>
                            <div class="main-page__views-b js-views-b">
            ...
            <div class="main-page__title-b">
                <h3 class="news__title"><a href="/neworta/courses">Курстар</a></h3>
            </div>
            <div class="main-page__news-b floated">
                <?php
                $i = 1;
                foreach ($course as $article) {?>
                    <?if(false && $i == 1){?>
                        <div class="main-page__news-main">
                            <img src="<?=$article['img']?>" class="main-page__news-main__img"/>
                            <div class="main-page__views-b js-views-b">
        ...
        <div class="sidebar">
            ...
            <!--div class="sidebar__news-b" style="border: none;padding: 0;">
                    <div class="sidebar__news">
                        <a href="http://www.oyo.kz/Mol/Home.html" target="_blank"><img src="/img/banner_2.jpg" style="padding-bottom:10px;"></a>
                    </div>
                    <div class="sidebar__news">
            ...
            <div class="sidebar__orta">
                <a href="/main/ortalyk/aqmola" class="sidebar__orta-link">Ақмола облысы</a>
                <a href="/main/ortalyk/aqtobe" class="sidebar__orta-link">Ақтөбе облысы</a>
                 <a href="/main/ortalyk/nursultan" class="sidebar__orta-link">Нұр-Сұлтан қаласы</a>
                <a href="/main/ortalyk/almatyobl" class="sidebar__orta-link">Алматы облысы</a>
                <a href="/main/ortalyk/almaty" class="sidebar__orta-link">Алматы қаласы</a>
                <a href="/main/ortalyk/atyrau" class="sidebar__orta-link">Атырау облысы</a>
                <a href="/main/ortalyk/batys" class="sidebar__orta-link">Батыс Қазақстан облысы</a>
                <a href="/main/ortalyk/jambil" class="sidebar__orta-link">Жамбыл облысы</a>
                <a href="/main/ortalyk/qaraganda" class="sidebar__orta-link">Қарағанды облысы</a>
                <a href="/main/ortalyk/qostanay" class="sidebar__orta-link">Қостанай облысы</a>
                <a href="/main/ortalyk/qyzylorda" class="sidebar__orta-link">Қызылорда облысы</a>
                <a href="/main/ortalyk/turkestan" class="sidebar__orta-link">Түркістан облысы</a>
                <a href="/main/ortalyk/mangystau" class="sidebar__orta-link">Маңғыстау облысы</a>
                <a href="/main/ortalyk/pavlodar" class="sidebar__orta-link">Павлодар облысы</a>
                <a href="/main/ortalyk/soltystik" class="sidebar__orta-link">Солтүстік Қазақстан облысы</a>
                <a href="/main/ortalyk/shygys" class="sidebar__orta-link">Шығыс Қазақстан облысы</a>
