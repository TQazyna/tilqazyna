<?php
$this->title = 'Тіл Әлемі - Үздік сабақ';
    ...
    <div class="news-page__in floated">
        <div class="main-page__left">
            <div class="breadcrumb-b">
                <span class="breadcrumb">Тұғыр   /   Үздік сабақ</span>
            </div>
            <h3 class="news__title">Үздік сабақ</h3>
            ...
            <div class="main-page__news-b floated">
                ...
                <div class="main-page__news">
                    <div class="main-page__news__img-b">
                        ...
                        <a href="/lesson/<?echo $art['id']."-".$art['preview'].".html";?>" class="main-page__news__link js-views-link"></a>
                    ...
                    <div class="main-page__news__body">
                        ...
                        <a href="/lesson/<?echo $art['id']."-".$art['preview'].".html";?>">
