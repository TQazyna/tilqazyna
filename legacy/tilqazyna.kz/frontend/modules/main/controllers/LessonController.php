...
class LessonController extends Controller
{
    ...
    public function actionIndex($id=null)
    {
        ...
        $art->views++;
        $art->save();
        $cat = \common\models\Lessons::getCatById($art['cat_id']);
        $cat_id = $cat['id'];
        $mores = \common\models\Lessons::find()->where(['not in','id',$id])->andWhere(['cat_id'=>$cat_id])->limit(3)->orderBy("id desc")->all();
