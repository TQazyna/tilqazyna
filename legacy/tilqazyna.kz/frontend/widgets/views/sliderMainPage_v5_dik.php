...
?>
	...
	<div id="diktant_modal" class="diktant-modal" style="display:block">
		<div class="diktant-content">
			<a class="cl-modal" onclick="oncl();" style=" color: #000; font-size: 18px; right: 10px;">[x] жабу</a>
			<a href="https://www.youtube.com/watch?v=mB0wWuWUftA"><img style="width:100%;" src="/img/banner_640.jpg"></a>
			<!--<video id="d_video" style="width:100%" muted autoplay >
				<img src="/img/banner_kk.jpg" style="width:200px; height: 150px;"></img>
				<source src="http://emle.kz/assets/banner480.mp4" type="video/mp4"> 
			</video>-->
			<p style="text-align:center;margin-top:15px;"><a onclick="oncl();" target="_blank" id="open_diktant" class="open_diktant" href="https://www.youtube.com/watch?v=mB0wWuWUftA">Толығырақ</a></p>
		</div>
	</div>
