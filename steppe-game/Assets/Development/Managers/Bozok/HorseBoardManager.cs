...
public class HorseBoardManager : MonoBehaviour
{
    ...
    [SerializeField] private BozokHorseQuizManager bozokHorseQuizManager;
    ...
    {
        if (bozokHorseQuizManager.CheckIfButtonSequenceIsCorrect(boardIndex) && (isPen ? !bozokHorseQuizManager.PenBoardIsMoving() : !bozokHorseQuizManager.CloudBoardIsMoving()))
        {
            InitializeMovment();
            bozokHorseQuizManager.ButtonByIndexStartedMovment(boardIndex);
        }
    }
